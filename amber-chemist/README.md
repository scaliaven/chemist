...
- Solvation: explicit (TIP3P / OPC / SPCE / TIP4P-Ew) or implicit GB (`--implicit-solvent {gb1, gb2, gb5, gb7, gb8}`; default `gb2` = GBneck2). Implicit means `ntb=0, igb=N, cut=999`, no barostat.
