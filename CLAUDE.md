...
1. **`ase-simulation`** — atomistic simulation orchestration on top of
   ...
   (SP / Opt / Freq)** in v1.4+.
2. **`amberchemist`** — Amber-native sibling skill, MD-first. Ships
...
method-selection behavior. v2 phase sequencing for `ase-simulation` is tracked
in `PLAN.md`.
...
├── amberchemist/                      # development source for the second skill
│   ├── SKILL.md, README.md
│   ├── scripts/
...
├── .claude/skills/ase-simulation/     # project-scoped copy of ase-simulation
├── .claude/skills/amberchemist/       # project-scoped copy of amberchemist
├── PLAN.md                            # v2 phase sequencing for ase-simulation
...
1. `amberchemist/` (this repo, dev source)
2. `.claude/skills/amberchemist/` (project skill)
3. `~/.claude/skills/amberchemist/` (user skill)
...
# amberchemist
rsync -a --delete amberchemist/ .claude/skills/amberchemist/
rsync -a --delete amberchemist/ ~/.claude/skills/amberchemist/
diff -rq amberchemist .claude/skills/amberchemist
diff -rq amberchemist ~/.claude/skills/amberchemist
```
